<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EditRecord.aspx.vb" Inherits="Test.EditRecord" %>
...
<body>
    <div style="margin-left:15px; margin-top:30px;">
        ...
        <p style="color:lightgrey;">ID <input id="id" type="text" name="id" style="margin-left:72px; border-radius:10px; height:20px" size="25"/></p>
            ...
            $.ajax(
                {
                    ...
                    success: function (response)
                    {
                        alert("Your record is editted successfully!");
                        window.close();
                    },
                    error: function (xhr, status, err)
                    {
